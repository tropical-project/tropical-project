...
NCCL_PATH = os.getenv("NCCL_PATH", "/usr/")
...
class cmake_build_ext(build_ext):
    ...
    def build_extensions(self) -> None:
        ...
        for ext in self.extensions:
            ...
            ext_target_name = remove_prefix(ext.name, "sgir_distserve.")
...
def get_vllm_version() -> str:
    version = find_version(get_path("sgir_distserve", "__init__.py"))
...
if not _is_neuron():
    ext_modules.append(CMakeExtension(name="sgir_distserve._C"))
